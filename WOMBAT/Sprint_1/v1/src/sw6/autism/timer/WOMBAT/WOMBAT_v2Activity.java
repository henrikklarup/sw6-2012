...
public class WOMBAT_v2Activity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        final ArrayAdapter<String> adapter2 = new ArrayAdapter<String> (this, android.R.layout.simple_list_item_1, items2);
	 ...
	 public String[] items1 = {"Afghanistan", "Albania", "Algeria", "American Samoa", "Andorra",
	 ...
	 public String[] items2 = {"Bente", "Kurtine", "Olea"};
}