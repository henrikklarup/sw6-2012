...
% tasks
\newcommand{\wheels}[1][]{\textbf{\caseControl{W}{heels}{#1}{}}}
\newcommand{\distance}[1][]{\textbf{\caseControl{D}{istance}{#1}{}}}
\newcommand{\steering}[1][]{\textbf{\caseControl{S}{teering}{#1}{}}}
\newcommand{\measure}[1][]{\textbf{\caseControl{M}{easure}{#1}{}}}%
\newcommand{\leftmeasure}[1][]{\textbf{\caseControl{L}{eftMeasure}{#1}{}}}%
\newcommand{\rightmeasure}[1][]{\textbf{\caseControl{R}{ightMeasure}{#1}{}}}%
\newcommand{\leftMeasure}[1][]{\leftmeasure[#1]}%
\newcommand{\rightMeasure}[1][]{\rightmeasure[#1]}%
\newcommand{\initialize}[1][]{\textbf{\caseControl{I}{nitialize}{#1}{}}}%
\newcommand{\watchdog}[1][]{\textbf{\caseControl{W}{atchdog}{#1}{}}}%
\newcommand{\mainquestion}{\textit{How can we design and implement a road-train system consisting of one leader vehicle and one follower vehicle, using LEGO NXT?}}

\newcommand{\lego}[1][]{\caseControl{LEGO}{}{#1}{}}%
\newcommand{\runner}[1][]{Runner{#1}{}}%
\newcommand{\stalker}[1][]{Stalker{#1}{}}%
\newcommand{\roadtrain}[1][]{\caseControl{r}{oad-train}{#1}{}}%
\newcommand{\realtime}[1][]{\caseControl{r}{eal-time}{#1}{}}%
\newcommand{\runtime}[1][]{\caseControl{r}{un-time}{#1}{}}%
\newcommand{\rts}[1][]{\realtime[#1] system}%
\newcommand{\irseeker}[1][]{\caseControl{IR}{Seeker}{#1}{}}%
\newcommand{\osek}[1][]{\caseControl{n}{xtOSEK}{#1}{}}
\newcommand{\nxtosek}[1][]{\osek[#1]}
\newcommand{\es}[1][]{\caseControl{e}{mbedded system}{#1}{}}
\newcommand{\lejos}[1][]{\caseControl{l}{eJOS}{#1}{}}
\newcommand{\embeddedsystem}[1][]{\es[#1]}
