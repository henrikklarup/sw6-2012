...
\begin{figure}[H]
	\centering
		\includegraphics[scale=0.50]{images/ledger} %FIXME epstopdf package fucker, har ændret noget her
...
For a connection of type commit or request, the procedure is almost the same. However, when the \code{CommunicationThread} has been created and its \code{TransmissionHandler} has determined the type of the connection, it will as opposed to the ping, create a new event corresponding to the type and send it to the \code{EventQueue}, see \autoref{fig:IOCR}.
