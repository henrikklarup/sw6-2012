...
The \code{<AuthUsers>..content..} \code{</AuthUsers>} element identifies the table on which we want to make changes, the following \code{<Entry>..content..} \code{</Entry>} elements
...
\noindent \url{/Group_server/xml/sw6_example.xml} %TODO fix this document before handin;-)