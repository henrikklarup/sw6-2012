...
define what row and what kind of action, through the \code{action="foo"} attribute, should be done on the row. 
...
\end{lstlisting}
The \code{action="foo"} attribute has four legal types corresponding to the CRUD profile actions, create, read, update, and delete, shown in \autoref{code:sw6mlCrud}.
