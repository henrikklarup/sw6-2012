...
\newcommand{\localgroup}[1][]{{project group}{#1}{}}
\newcommand{\globalgroup}[1][]{{multiproject group}{#1}{}}
\newcommand{\egebakken}[1][]{{Egebakken}{#1}{}}
\newcommand{\guardian}[1][]{{guardian}{#1}{}}
\newcommand{\autist}[1][]{{child with austim}{#1}{}}
\newcommand{\autists}[1][]{{children with austim}{#1}{}}
