...
\documentclass[
		twoside,openright,titlepage,numbers=noenddot,headinclude,%1headlines, %%%%%%%%%, openright
...
\newcommand{\autist}[1][]{\caseControl{c}{hild}{#1}{}}
\newcommand{\autists}[1][]{\caseControl{c}{hildren}{#1}{}}
