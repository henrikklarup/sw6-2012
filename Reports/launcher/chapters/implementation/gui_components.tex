...
The principle of extending android classes is  is applied to all the classes listed earlier in an itemize, and the the inheritance for all components in the library are shown in \autoref{appendix:guiinheritance}.
