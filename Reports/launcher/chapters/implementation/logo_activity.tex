...
The logo activity implements TIME-AUTO-LOGIN-FEATURE -- explained in \autoref{sec:autologin} -- by using the \method{sessionExpired} method, found in \class{Tools} class, seen in \autoref{lst:sessionexpired}.
