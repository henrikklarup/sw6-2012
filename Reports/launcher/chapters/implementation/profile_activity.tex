...
The \activity{ProfileSelectActivity} activity implements the behavior described in \autoref{FIXME} \todo{indsaet ref til design afsnittet, hvor vi snakker om dette behavior}, and takes care of providing the profile service, described in \autoref{sec:launcher_architecture}, to the launched \girafapp[].
