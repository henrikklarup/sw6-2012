\section{ProfileSelectActivity}

The \activity{ProfileSelectActivity} implements the behavior described in \autoref{design:profile_selection}, and takes care of providing the profile service, described in \autoref{sec:design_overview}.
