...
\autoref{fig:flow_diagram} shows the states of the launcher. %The first three states handles the distinction between users which are allowed to access the launchable applications, and those who are not. 
