...
The illustrated service is the ability to launch a specific \girafapp[] as a guardian, with a child profile, as explained in \autoref{FIXME} \todo{indsaet ref til hvor servicen er forklaret}.
