...
As seen on \autoref{cmn:fig:architecture} \todo{Ref not working}, Oasis is available for the launcher to use. This database stores the modulated data, including the guardian and child profiles on the device in a local database.
