...
The background also got the round corners which all clickable buttons have \autoref{GUI:buttons} and the backgrounds was design so that the buttons got bigger to accomondate that children have worse fine fingerskills than adults \todo{Mikael Skov: fine fingerskills reference}.
