...
%We have made test design and test cases for some of the most important functionality, so that we could outsource the test to one of the other project groups, if they had time to help us. 
%This was not the case, so we did the testing ourselves.
