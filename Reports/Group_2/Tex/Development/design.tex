\chapter{Design}
\textit{The design of WOMBAT has changed throughout the project. The design chapter presents the vision of the timer application and some of the tools used when designing and developing it.} % Rettet
