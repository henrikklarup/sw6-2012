...
These listeners then stores information and listens for different actions, which include DRAG_STARTED and DROP which helps us define different behavior.
