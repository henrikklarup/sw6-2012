\documentclass[11pt,english,a4paper,twoside,titlepage,openright]{memoir}
...
%\lstset{language=XML,captionpos=b,caption={Descriptive Caption Text},label=DescriptiveLabel, frame=tb}
