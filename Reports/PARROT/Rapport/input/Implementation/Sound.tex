...
In PARROT, the playing of sounds are handled in two different places in cooperation, the Pictogram class see Source Code \ref{pictoplay} and the AudioPlayer class see Source Code \ref{audioplay}.\newline
