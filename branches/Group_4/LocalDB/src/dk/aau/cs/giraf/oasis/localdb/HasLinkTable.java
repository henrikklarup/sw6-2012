...
public class HasLinkTable {
	...
	private static final String TABLE_CREATE = "CREATE TABLE "
			...
			+ "("
			+ HasLinkMetaData.Table.COLUMN_IDPARENT + " INTEGER, "
			+ HasLinkMetaData.Table.COLUMN_IDCHILD + " INTEGER, "
			+ "PRIMARY KEY(" + HasLinkMetaData.Table.COLUMN_IDPARENT + ", " + HasLinkMetaData.Table.COLUMN_IDCHILD + ")"
			+ ");";
