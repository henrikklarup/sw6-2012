...
public class TimerHelper {
	...
	public void LoadTestData(){
		...
		DigitalClock digital1 = new DigitalClock("red Digital clock", "red digital 100% size", 100, 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff, false);
		...
		DigitalClock digital3 = new DigitalClock("blue Digital clock", "blue digital 25% size 1min", 25, 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff, true);
		DigitalClock digital4 = new DigitalClock("blue Digital clock", "blue digital 25% size 1min", 25, 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff, true);
		DigitalClock digital5 = new DigitalClock("blue Digital clock", "blue digital 25% size 1min", 25, 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff, true);
